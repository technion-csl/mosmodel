...
$(MEM_BINS_4KB_CSV_FILE): $(MEM_ACCESS_COUNT_FILE) | $(PEBS_EXP_OUT_DIR) 
...
$(MEM_BINS_2MB_CSV_FILE): $(MEM_BINS_4KB_CSV_FILE) | $(PEBS_EXP_OUT_DIR) 
	{ $(PERF_MEM_REPORT_PREFIX) -i $(word 1,$|)/perf.data report | \
		$(FIX_DELIM_IN_PERF_MEM_OUTPUT_HEADER) | \
...
$(MEM_ACCESS_COUNT_FILE): $(MEM_ACCESSES_FILE) | $(PEBS_EXP_OUT_DIR) 
	{ $(PERF_MEM_REPORT_PREFIX) -i $(word 1,$|)/perf.data report | \
		$(FIX_DELIM_IN_PERF_MEM_OUTPUT_HEADER) | \
