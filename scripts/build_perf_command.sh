...
prefix_perf_command="perf stat --interval-print=1000 --field-separator=, --output=\${MOSMODEL_RUN_OUT_DIR}/perf.out"
...
dtlb_events="mem_inst_retired.all_loads,mem_inst_retired.all_stores,mem_inst_retired.stlb_miss_loads,mem_inst_retired.stlb_miss_stores,dtlb_load_misses.walk_completed,dtlb_store_misses.walk_completed"
